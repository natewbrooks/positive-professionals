...
import CoreValuesItem from './CoreValueItem';
import waveTop from '../../../../static/img/bg-waves/core-value-waves/wave-top.svg';
import waveBottom from '../../../../static/img/bg-waves/core-value-waves/wave-bottom.svg';
	...
	return (
		<section
			...
			<div className='flex flex-col space-y-4 items-center justify-center py-4'>
				<div className='z-10 flex flex-col w-full text-center'>
