	...
	return (
		<header className='relative flex justify-center items-center w-full h-fit py-40'>
			<div className='pt-8 flex flex-col space-y-8 items-center justify-center h-full'>
					...
					<div className='relative flex flex-col -space-y-8'>
						<span className='z-10 break-words null:w-fit sm:w-[500px] lg:w-[740px] leading-none serif null:text-xxxl mobile:text-billboard text-center xbold text-dark dark:text-light/60  px-8 rounded-full'>
							...
							<span className='relative w-fit h-fit inline-block'>
								together.
								<img
									className='-z-10  absolute -bottom-1 right-1 opacity-80 w-[105%] ' // Adjust these properties
				...
				<div className='sans null:text-md mobile:text-lg  xbold text-light dark:text-dark bg-dark dark:bg-four cursor-pointer select-none md:hover:opacity-50 active:scale-95 p-2 rounded-md'>
					GET STARTED
				</div>
			</div>
		</header>
