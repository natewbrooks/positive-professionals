	...
	return (
		<div
			...
			<div className='flex flex-col -space-y-1 mb-8 items-center text-center justify-center text-dark dark:text-light/70'>
				<span className='serif null:text-xxl mobile:text-xxxl dark:text-light/80 leading-none pb-4'>
					{data.header}
				</span>
				<span className='w-[280px] mobile:w-full sans text-md'>{data.subtext}</span>
			</div>

			<div className='flex flex-col space-y-12 md:space-y-0 md:flex-row md:space-x-4 lg:space-x-8 justify-center items-center'>
							...
							<div
								...
								<div className='flex flex-col space-y-4 items-center justify-center text-dark dark:text-light/70'>
									...
									<div className='flex flex-col items-center justify-center text-center'>
										...
										<span className='sans text-sm w-[240px] xl:w-[300px] text-center dark:text-light/50'>
											{step.explanation}
										</span>
									</div>
								</div>
