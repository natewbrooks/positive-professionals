	...
	return (
		<>
			<div
				...
				<div className='relative group-md:hover:opacity-50 null:py-4 md:py-8 lg:py-12 h-full flex flex-col items-center justify-center space-y-2  group-hover:opacity-80 bg-light/30  px-8 rounded-md'>
