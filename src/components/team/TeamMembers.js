...
export default function TeamMembers({ gridItems, colors }) {
	...
	return (
		<div className='w-full h-full flex justify-center pt-[4rem]'>
			<div className='flex flex-col null:space-y-[8rem] md:space-y-[0rem] md:gap-y-[8rem] md:grid md:grid-cols-2 null:gap-x-6 xxl:gap-x-20  w-fit h-fit place-items-end justify-items-center '>
