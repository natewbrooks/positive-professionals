...
const TestimonialItem = forwardRef(({ id, testimonial, style, borderColor }, ref) => {
	...
	return (
		<div
			...
			<div
				style={style}
				className={`active:cursor-grabbing hover:cursor-grab ${borderColor} select-none rounded-r-md rounded-l-sm h-full justify-center text-start relative flex flex-col -space-y-1 bg-dark/10 border-l-4 p-4 `}>
