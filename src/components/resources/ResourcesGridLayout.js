...
const ResourcesGridLayout = ({ mediaItems }) => {
	...
	return (
		<div className='w-full h-full mb-20'>
			...
			<div className='w-full null:text-center sm:text-end text-dark/50 dark:text-light/50 sans xbold text-sm pb-4 sm:pb-2'>
			...
			{!hasMoreItems && (
				<div className='w-full null:text-center sm:text-end pt-4'>
					<span className={`text-secondary xbold sans text-nowrap text-sm`}>END OF RESULTS</span>
				</div>
			)}
		</div>
	);
